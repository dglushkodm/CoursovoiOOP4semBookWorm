...
public class CatalogAdminViewModel:INotifyPropertyChanged
{
    ...
    private List<Book> _booksStatus;
    private List<Book> _booksStatusEnd;
    private List<Book> _booksStatusOng;
    private List<Book> _booksStatusZab;
    ...
    private DelegateCommand _addRedirectCommand;
    public ICommand AddRedirectCommand
    {
        get
        {
            if (_addRedirectCommand == null)
                _addRedirectCommand = new DelegateCommand(AddRedirect);
            return _addRedirectCommand;
        }
    }
    ...
    private void AddRedirect()
    {
        ...
        mainFrame.Navigate(new AddBook());
