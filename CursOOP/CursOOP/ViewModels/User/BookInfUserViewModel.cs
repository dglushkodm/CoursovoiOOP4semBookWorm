...
public class BookInfUserViewModel: INotifyPropertyChanged
{
    ...
    private Book _book;
    public BookInfUserViewModel(){}
    public BookInfUserViewModel(Guid id)
    {
    ...
    public void AddComment()
    {
        try
        {
            var com = new Review()
            {
                BookId = _book.Id, ReviewText = Review, UserId = _user.Id, UserName = _user.Username,
